...
# fileparam["randompre-1"].extend([5, 1, 0])

#mqtt: 100KB
fileparam["random-mqtt"].extend([1000, 255, 0])
...
# for 1 stream
# fileparam["random-single"].extend([50000, 255, 0])

#for 2 streams: RR minrtt ECF
# fileparam["random0"].extend([50000, 254, 0])
# fileparam["random1"].extend([50000, 254, 0])

# for 5 small streams
# fileparam["random5"].extend([1280, 255, 0])
# fileparam["random6"].extend([1280, 255, 0])
# fileparam["random7"].extend([1280, 255, 0])
# fileparam["random8"].extend([1280, 255, 0])
# fileparam["random9"].extend([1280, 255, 0])

# 2 different streams(1): 1 big high priority stream,  1 small low priority stream
# fileparam["random-samll"].extend([50000, 50, 0])
# fileparam["random-big"].extend([100000, 250, 0])

# 2 different streams(2): 1 small high priority stream,  1 big low priority stream
# fileparam["random-high"].extend([50000, 250, 0])
# fileparam["random-low"].extend([100000, 50, 0])

# 2 different streams(3): stream-1: high pri small size, stream-2: low pri big size
# fileparam["random-high-small"].extend([5000, 255, 0])
# fileparam["random-low-big"].extend([100000, 50, 0])

# 2 different streams(4): stream-1: high pri big size, stream-2: low pri small size
# fileparam["random-high-big"].extend([100000, 250, 0])
# fileparam["random-low-small"].extend([5000, 50, 0])

#for 2 big streams
# fileparam["random0"].extend([100000, 255, 0])
# fileparam["random1"].extend([100000, 255, 0])

# for 3 different priority streams (40Mb)
# fileparam["random-high"].extend([50000, 255, 0])
# fileparam["random-medium"].extend([50000, 150, 0])
# fileparam["random-low"].extend([50000, 50, 0])

# for 3 small streams diff priority
# fileparam["random-high"].extend([1000, 255, 0])
# fileparam["random-medium"].extend([1000, 150, 0])
# fileparam["random-low"].extend([1000, 50, 0])
...
class MpExperienceQUIC(MpExperience):
	...
	CLIENT_GO_FILE = "~/go/src/github.com/lucas-clemente/" + MPQUIC_DIR + "/example/client_branch/main.go"
	# CLIENT_GO_FILE = "~/go/src/github.com/lucas-clemente/pstream/example/client_serial/main.go"
	CLIENT_DEEPTREE_GO_FILE = "~/go/src/github.com/lucas-clemente/" + MPQUIC_DIR + "/example/client_browse_deptree/main.go"
	SERVER_GO_FILE = "~/go/src/github.com/lucas-clemente/" + MPQUIC_DIR + "/example/main.go"
	CERTPATH = "~/go/src/github.com/lucas-clemente/" + MPQUIC_DIR + "/example/"
